          ...
          >
            {beneficios.map((b, i) => (
              ...
              >
                ...
                <div>
                  <h4 className='text-lg lg:text-xl font-semibold text-color-primary-light mb-1'>
                    {b.titulo}
                  </h4>
                  <p className='text-color-text-light font-medium md:text-lg max-w-xs md:max-w-sm lg:max-w-lg'>
                    {b.descripcion}
                  </p>
                </div>
              </div>
